...
/**
* The shutdown() method is responsible for coordinating the shutdown of the logger.
* It needs to close the msgCh channel to prevent the logger from receiving new messages,
* and then to send a message on the shutdownCompleteCh channel when it's done.
 */
